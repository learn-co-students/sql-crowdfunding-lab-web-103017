...
def selects_the_titles_and_amount_over_goal_of_all_projects_that_have_met_their_funding_goal
  # Need projects tabels and the sum of the amounts of the project id if it is over the projects amount
  # SUM of the amounts for a given project SUM(pledges.amount GROUP BY project_id)
