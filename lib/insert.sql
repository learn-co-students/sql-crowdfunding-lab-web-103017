-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("fun park", 1000, "10/21/17", "11/14/18");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("contraption", 12000, "10/18/17", "12/14/18");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("intertron", 3000, "10/28/17", "1/14/18");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("neil's house", 35000, "10/21/20", "11/14/22");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("ragnarok", 15000, "10/21/19", "11/14/20");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("fun park", 1000, "10/21/17", "11/14/18");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("fun park", 1000, "10/21/17", "11/14/18");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("fun park", 1000, "10/21/17", "11/14/18");
-- INSERT INTO projects (title, category, funding_goal, start_date, end_date) VALUES ("fun park", 1000, "10/21/17", "11/14/18");
